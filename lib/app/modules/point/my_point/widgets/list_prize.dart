          ...
          children: [
            Padding(
              ...
              child: BaseSearchField(
                ...
                onChanged: (value) {
                  ...
                  controller.listPrize.value = controller.prize
                      .where((e) => e.prizeDesc
                          .toString()
                          .toLowerCase()
                          .contains(
                              controller.searchPrize.value?.toLowerCase() ??
                                  ''))
                      .toList();
                },
            ...
            Expanded(
              child: GridView.builder(
                ...
                itemCount: controller.prize.length,
                itemBuilder: (context, index) {
                  final prizeData = controller.prize[index];

                  return PrizeCard(
                    prizePoint: prizeData.point,
