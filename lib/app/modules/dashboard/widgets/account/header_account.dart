        ...
        decoration: BoxDecoration(
          ...
          gradient: controller.token.value == null ||
              ...
              : controller.profile.value?.loyalty?.toLowerCase() == 'silver'
                  ...
                  : controller.profile.value?.loyalty?.toLowerCase() == 'gold'
                      ? const LinearGradient(
                          colors: [
                            Color(0xFFD09A00),
                            Color(0xFFFFD285),
                ...
                children: [
                  controller.token.value == null
                      ...
                      : controller.profile.value == null
                          ...
                          : MemberCardAccountLogin(
                              category: controller.profile.value?.loyalty
                                      ?.toLowerCase() ??
                                  '',
                              profileImage:
                              ...
                              noMember: controller.profile.value?.codeName ?? '',
                              phoneNumber:
                  ...
                  if (controller.token.value != null)
                    Column(
                      children: [
                        PointVoucherBox(
                          totalPoint: controller.profile.value?.loyaltyPoint.toString() ?? '',
                          totalVoucher: controller
                                  .profile.value?.voucherTotal
                                  ?.toString() ??
                              '',
